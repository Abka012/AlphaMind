...
if __name__ == "__main__":
    ...
    print(f"# Horizon: {HORIZON} ticks | Threshold: {THRESHOLD}")
    print(f"{'#'*50}")
    ...
    print("="*50)
    print(f"{'Symbol':<10} {'Trades':>8} {'Win%':>8} {'PF':>8} {'Sharpe':>10} {'DD':>8}")
    print("-" * 50)
    
    total_trades = 0
    for r in all_results:
        print(f"{r['symbol'].upper():<10} {r['trades']:>8} {r['win_rate']*100:>7.1f}% {r['profit_factor']:>8.2f} {r['sharpe']:>10.2f} {r['max_drawdown']:>8.3f}")
